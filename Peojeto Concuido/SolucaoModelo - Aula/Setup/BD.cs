    ...
    public class BD
    {
        ...
        public static void EmailAdmin(string Login, string Senha, string acao)
        {
            using (SmtpClient s = new SmtpClient())
            {
                ...
                s.Credentials = new NetworkCredential("sistema.edivam@gmail.com", "edivam123@");

                using (MailMessage m = new MailMessage())
                {
                    m.From = new MailAddress("sistema.edivam@gmail.com");
                    m.To.Add(new MailAddress("contato@edivamcabral.com.br"));
